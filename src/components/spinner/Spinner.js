const Spinner = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={{display: 'block', background: 'none', margin: '0 auto'}} width="250" height="250" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
